...
def main():
    ...
    wandb.init(project="Research Project", name="dora-3B-finetune", reinit=True)
    ...
    if not args.run_tag:
        ...
        args.run_tag = f"{base_name}_dora_e{args.epochs}_lr{args.lr}_{stamp}"
