...
# -*- coding: utf-8 -*-
"""
DoRA Finetune for FinQA — clean structure, patched for collator bugs.
- Custom collator strips non-tensor fields.
- remove_unused_columns=True in TrainingArguments.
- Remote checkpoints each epoch + final upload; no persistent local saves.
"""
...
def main():
    ...
    wandb.init(project="Research Project", name="dora-1B-finetune", reinit=True)
    ...
    lora_cfg = LoraConfig(
        ...
        use_dora=True,
        # You can expand targets to attn+MLP for better accuracy:
    ...
    training_args = TrainingArguments(
        ...
        eval_strategy="epoch",         
        save_strategy="epoch",
        # If you're NOT in 4-bit, prefer:
        optim="adamw_torch_fused",
        # If you *are* in 4-bit QLoRA-like setup, switch to:
